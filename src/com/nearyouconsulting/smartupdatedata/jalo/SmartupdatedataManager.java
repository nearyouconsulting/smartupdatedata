...
/**
 * This is the extension manager of the Smartupdatedata extension.
 */
public class SmartupdatedataManager extends GeneratedSmartupdatedataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SmartupdatedataManager.class);
	 ...
	 */
	public static SmartupdatedataManager getInstance()
	{
		return (SmartupdatedataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SmartupdatedataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SmartupdatedataManager() // NOPMD 
	{
		LOG.debug("constructor of SmartupdatedataManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SmartupdatedataManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SmartupdatedataManager called, current tenant: {}", getTenant().getTenantID());
	}
