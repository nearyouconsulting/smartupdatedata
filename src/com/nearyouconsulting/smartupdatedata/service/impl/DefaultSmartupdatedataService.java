...
public class DefaultSmartupdatedataService implements SmartupdatedataService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSmartupdatedataService.class);
	...
	{
		return DefaultSmartupdatedataService.class.getResourceAsStream("/smartupdatedata/sap-hybris-platform.png");
	}
